...
from .add_empties_animations import create_and_add_from_empty
...
def from_scene(context: bpy.types.Context,
    ...
    war3_model.materials = [get_new_material(mat, war3_model.geosets, war3_model.sequences, war3_model.global_seqs) for mat in materials]
...
def parse_bpy_objects(context: bpy.types.Context,
    ...
    for bpy_obj in objects:
        ...
        if len(bpy_obj.particle_systems):
            add_particle_systems(war3_model, billboard_lock, billboarded, materials, bpy_obj, parent_name, settings)
        ...
        # Collision Shapes
            ...
            make_mesh(war3_model, billboard_lock, billboarded, context, materials, bpy_obj, parent_name, settings)
            ...
            print("   id_data.isArmature: ", isinstance(bpy_obj.id_data, bpy.types.Armature))
            print("   data.isArmature: ", isinstance(bpy_obj.data, bpy.types.Armature))
