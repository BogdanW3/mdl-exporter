...
def add_lights(war3_model: War3Model, billboard_lock, billboarded, obj, settings):
    ...
    if hasattr(obj.data, "mdl_light"):
        ...
        light.intensity_anim = get_wc3_animation_curve(obj.data.animation_data, 'mdl_light.intensity', 1, war3_model.sequences)
        ...
        light.atten_start_anim = get_wc3_animation_curve(obj.data.animation_data, 'mdl_light.atten_start', 1, war3_model.sequences)
        ...
        light.atten_end_anim = get_wc3_animation_curve(obj.data.animation_data, 'mdl_light.atten_end', 1, war3_model.sequences)
        ...
        light.color_anim = get_wc3_animation_curve(obj.data.animation_data, 'mdl_light.color', 3, war3_model.sequences)
        ...
        light.amb_color_anim = get_wc3_animation_curve(obj.data.animation_data, 'mdl_light.amb_color', 3, war3_model.sequences)
        ...
        light.amb_intensity_anim = get_wc3_animation_curve(obj.data.animation_data, 'mdl_light.amb_intensity', 1, war3_model.sequences)
