...
# from ..import_stuff.mdl_parser.load_mdl import load_mdl
# from ..import_stuff.mdx_parser.load_mdx import load_mdx
#
#
# def set_team_color_property(operator, context):
#     operator.teamColor = constants.TEAM_COLORS[operator.setTeamColor]
#
#
# class WAR3_OT_import_mdl(bpy.types.Operator, io_utils.ImportHelper):
