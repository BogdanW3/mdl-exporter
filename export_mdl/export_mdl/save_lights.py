    ...
    for light in model.objects['light']:
        ...
        if light.atten_start_anim is not None:
            write_mdl(light.atten_start_anim.keyframes, light.atten_start_anim.type,
                      ...
                      light.atten_start_anim.handles_left, light.atten_start_anim.handles_right, "AttenuationStart", fw,
                      model.global_seqs,
        ...
        if light.atten_end_anim is not None:
            write_mdl(light.atten_end_anim.keyframes, light.atten_end_anim.type, light.atten_end_anim.interpolation,
                      light.atten_end_anim.global_sequence, light.atten_end_anim.handles_left,
                      light.atten_end_anim.handles_right, "AttenuationEnd", fw, model.global_seqs,
        ...
        if light.color_anim is not None:
            write_mdl(light.color_anim.keyframes, light.color_anim.type, light.color_anim.interpolation,
                      light.color_anim.global_sequence, light.color_anim.handles_left, light.color_anim.handles_right,
        ...
        if light.intensity_anim is not None:
            write_mdl(light.intensity_anim.keyframes, light.intensity_anim.type, light.intensity_anim.interpolation,
                      light.intensity_anim.global_sequence, light.intensity_anim.handles_left,
                      light.intensity_anim.handles_right, "Intensity", fw, model.global_seqs,
        ...
        if light.amb_intensity_anim is not None:
            write_mdl(light.amb_intensity_anim.keyframes, light.amb_intensity_anim.type,
                      ...
                      light.amb_intensity_anim.handles_left, light.amb_intensity_anim.handles_right, "AmbIntensity", fw,
                      model.global_seqs,
        ...
        if light.amb_color_anim is not None:
            write_mdl(light.amb_color_anim.keyframes, light.amb_color_anim.type, light.amb_color_anim.interpolation,
                      light.amb_color_anim.global_sequence, light.amb_color_anim.handles_left,
                      light.amb_color_anim.handles_right, "AmbColor", fw, model.global_seqs,
        ...
        if light.visibility is not None:
            write_mdl(light.visibility.keyframes, light.visibility.type, light.visibility.interpolation,
                      light.visibility.global_sequence, light.visibility.handles_left, light.visibility.handles_right,
