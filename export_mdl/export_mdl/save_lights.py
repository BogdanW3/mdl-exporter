...
def save_lights(fw, model):
    for light in model.objects['light']:
        ...
        if light.atten_start_anim is not None:
            write_animations(light.atten_start_anim.keyframes, light.atten_start_anim.type,
        ...
        if light.atten_end_anim is not None:
            write_animations(light.atten_end_anim.keyframes, light.atten_end_anim.type,
        ...
        if light.color_anim is not None:
            write_animations(light.color_anim.keyframes, light.color_anim.type,
        ...
        if light.intensity_anim is not None:
            write_animations(light.intensity_anim.keyframes, light.intensity_anim.type,
        ...
        if light.amb_intensity_anim is not None:
            write_animations(light.amb_intensity_anim.keyframes, light.amb_intensity_anim.type,
        ...
        if light.amb_color_anim is not None:
            write_animations(light.amb_color_anim.keyframes, light.amb_color_anim.type,
        ...
        if light.visibility is not None:
            write_animations(light.visibility.keyframes, light.visibility.type,
