...
def save_ribbon_emitters(fw, model):
    for psys in model.objects['ribbon']:
        ...
        if psys.alpha_anim is not None:
            write_mdl(psys.alpha_anim.keyframes, psys.alpha_anim.type, psys.alpha_anim.interpolation,
                      psys.alpha_anim.global_sequence, psys.alpha_anim.handles_left, psys.alpha_anim.handles_right,
        ...
        if psys.ribbon_color_anim is not None:
            write_mdl(psys.ribbon_color_anim.keyframes, psys.ribbon_color_anim.type,
                      ...
                      psys.ribbon_color_anim.handles_left, psys.ribbon_color_anim.handles_right, "Color", fw,
                      model.global_seqs,
