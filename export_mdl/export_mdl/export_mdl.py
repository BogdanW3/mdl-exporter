...
from ..utils import f2s, calc_bounds_radius, rnd
        ...
        for material in model.materials:
            ...
            for layer in material.layers:
                ...
                if layer.alpha_anim is not None:
                    layer.alpha_anim.write_mdl("Alpha", fw, model.global_seqs,
...
def save_ribbon_emitters(fw, model):
    for psys in model.objects['ribbon']:
        ...
        if psys.ribbon_color_anim is not None:
            psys.ribbon_color_anim.write_mdl("Color", fw, model.global_seqs,
